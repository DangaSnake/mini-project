...
const ChatButton = (props) => {
    ...
    const handleBotResponse = (userInput) => {
        ...
        if (props.myKey == "0") {
            ...
            switch (keywordMatch) {
                case "help":
                    botText = "I'm here to help you on your small biz journey! Use keywords like courses - business plan - help and use keywords for more options!";
                    break;
                case "hello":
                    botText = "Hello! I'm BizBot, how can I help you today?";
                    break;
                case "keywords":
                    botText = "Here are the keywords you can use: help - hello - business plan - marketing - courses";
                    break;
                case "business plan":
                    botText = "Creating a business plan can seem like a daunting task, but it's a crucial step in starting or growing your business. There are many resources available to help you create a business plan, such as SCORE and the Small Business Administration";
                    break;
                case "marketing":
                    botText = "Marketing is a crucial aspect of any business. Some popular strategies include social media marketing, content marketing, email marketing, and influencer marketing. Try researching these options to see which ones would work best for your business.";
                break;
                case "courses":
                    botText = "There are many online courses available for small business owners. Some popular options include Coursera's Small Business Management course, Udemy's Entrepreneurship course, and the Small Business Management program on edX. Each of these courses offers a range of information!";
                    break;
                default:
                    botText = "Not sure what you mean, try typing keywords for a list of available options.";
            }
        } else {
            switch (keywordMatch) {
                /*Keywords for DesignBot */
                case "help":
                    botText = "I can help you with all things design and UI! Try typing UI - design - bootcamp and use keywords for more options!";
                    break;
                case "hello":
                    botText = "What's up I'm DesignBot, is there something I can help you with today?";
                    break;
                case "keywords":
                    botText = "Here are the keywords you can use: help - hello - UI - design - courses - resources";
                    break;
                case "design":
                    botText = "Design is a crucial aspect of any website or application. Some popular design principles include usability, user-centered design, and responsive design. Try researching these principles to see how they can improve your project.";
                    break;
                case "UI":
                    botText = "UI design, or user interface design, is the process of designing the look and feel of a website or application. Some popular tools for UI design include Sketch, Adobe XD, and Figma. Try researching these tools to see which one would work best for your project.";
                    break;
                case "resources":
                    botText = "There are many resources available for web and UI design. Some popular options include Behance, Dribbble, and A List Apart. Each of these websites offers a variety of design inspiration and tutorials.";
                    break
                case "courses":
                    botText = "There are many online courses available for web and UI design. Some popular options include Coursera's UI Design course, Udemy's Web Design course, and the Design Thinking program on edX. Each of these courses offers a range of information, such as design principles, prototyping and user research.";
                    break;
                default:
                    botText = "I'm not familiar with that, try typing keywords for a list of available options.";
            }
    ...
    return (
        <div onClick={handleClick} id={`chatbot-box-${props.myKey}`} className="chatbot-box">
